...
"""
Так как достигнуто требуемое минимальное покрытие?
a перемещение ингредиентов и печать чека не являются основными фичами,
на этом тестирование заканчиваем
Общий процент покрытия 90% - при требуемых 70%
"""